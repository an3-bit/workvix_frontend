...
const PostJobForm: React.FC = () => {
  ...
  const handleGoogleAuth = async () => {
    setLoading(true);
    try {
      // For now, redirect to sign in page since Google OAuth needs to be implemented in the backend
      toast({
        title: 'Google Sign In',
        description: 'Please use email and password to sign in for now.',
        variant: 'default',
      });
    } catch (error: any) {
      toast({
