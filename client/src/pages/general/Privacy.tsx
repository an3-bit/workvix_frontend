          ...
          <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                post a job, submit a bid, or contact us for support. This may include your name, email 
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                <a href="mailto:privacy@workvix.com" className="text-orange-500 hover:text-orange-600">
                  privacy@workvix.com
                </a>
              </p>
            </section>
