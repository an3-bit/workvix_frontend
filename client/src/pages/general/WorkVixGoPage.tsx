        ...
        <div className="container mx-auto px-4">
            ...
            {features.map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg">
                <CardHeader className="text-center">
                              <div className="mx-auto mb-4 p-3 bg-workvix-primary/10 rounded-full w-fit">
              <div className="text-workvix-primary">
                      {feature.icon}
                    </div>
                  </div>
              ...
              {services.map((service, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <div className="text-2xl font-bold text-workvix-primary">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg mb-16">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-workvix-primary to-blue-600 rounded-xl p-8 text-white">
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-workvix-primary text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                  1
                </div>
