        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-skillforge-primary/10 flex items-center justify-center mb-4">
                <span className="text-2xl font-bold text-skillforge-primary">1</span>
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-skillforge-primary/10 flex items-center justify-center mb-4">
                <span className="text-2xl font-bold text-skillforge-primary">2</span>
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-skillforge-primary/10 flex items-center justify-center mb-4">
                <span className="text-2xl font-bold text-skillforge-primary">3</span>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="flex items-start">
                <CheckCircle className="h-6 w-6 text-skillforge-primary mr-3 flex-shrink-0" />
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-skillforge-primary text-sm">{story.role}</p>
                  </div>
                </div>
